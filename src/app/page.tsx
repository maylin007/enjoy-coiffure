    ...
    <>
      ...
      <section className="py-28 px-6 bg-light">
        <div className="max-w-3xl mx-auto">
          <AnimatedSection>
            ...
            <h2 className="font-[family-name:var(--font-display)] text-3xl sm:text-4xl font-light text-dark mb-8 leading-tight">L&apos;expertise au quotidien</h2>
      ...
      <section className="py-28 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Femme */}
          <AnimatedSection>
            <p className="text-[11px] tracking-[0.3em] uppercase text-accent mb-4">Femme</p>
          ...
          {/* Homme */}
          <AnimatedSection>
            <p className="text-[11px] tracking-[0.3em] uppercase text-accent mb-4 mt-12">Homme</p>
            <div className="flex gap-3 overflow-x-auto pb-4 -mx-6 px-6 snap-x snap-mandatory scrollbar-hide">
              {[
          ...
          {/* Enfant */}
          <AnimatedSection>
            <p className="text-[11px] tracking-[0.3em] uppercase text-accent mb-4 mt-12">Enfant</p>
